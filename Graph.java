...
import java.io.*;
	...
	public class Graph
	{
		...
		public int numVetex() 
		{
			return Graph.vtces.size();
		}

		public boolean containsVertex(String vname) 
		{
			return Graph.vtces.containsKey(vname);
		}
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			g.addVertex("Rasulgarh");
			g.addVertex("New AG-Colony ");
			g.addVertex("Old AG-Colony Patel Marg");
			g.addVertex("Jaydev Vihar Traffic");
			g.addVertex("Utkal University Vani Vihar");
			g.addVertex("Rajmahal Square");
			g.addVertex("Shaeed Nagar Road");
			g.addVertex("Kalinga Vihar");
			g.addVertex("Khandagiri Square");
			g.addVertex("Old town Road");
			g.addVertex("Kalpana Square");
			g.addVertex("Damana Square");
			g.addVertex("KIIT");
			g.addVertex("NandanKanan Zoo");
			g.addVertex("Omfed Square");
			g.addVertex("Infocity");
			g.addVertex("Kalinga Stadium Gate 1");
			g.addVertex("BDA");
			g.addVertex("Fire Station Square");
			g.addVertex("CRPF Square");
			
			g.addEdge("Rasulgarh", "New AG-Colony", 8);
			g.addEdge("New AG-Colony ", "Old AG-Colony Patel Marg", 1);
			g.addEdge("Old AG-Colony Patel Marg", "Jaydev Vihar Traffic", 4);
			g.addEdge("Jaydev Vihar Traffic", "Utkal University Vani Vihar", 3);
			g.addEdge("Utkal University Vani Vihar", "Rajmahal Square", 8);
			g.addEdge("Rajmahal Square", "Shaeed Nagar Road", 5);
			g.addEdge("Shaeed Nagar Road", "Kalinga Vihar", 12);
			g.addEdge("Kalinga Vihar", "Khandagiri Square", 5);
			g.addEdge("Khandagiri Square", "Old town Road", 14);
			g.addEdge("Old town Road", "Kalpana Square", 7);
			g.addEdge("Kalpana Square", "Damana Square", 15);
			g.addEdge("Damana Square", "KIIT", 3);
			g.addEdge("KIIT", "NandanKanan Zoo", 5);
			g.addEdge("NandanKanan Zoo", "Omfed Square", 8);
			g.addEdge("Omfed Square", "Infocity", 5);
			g.addEdge("Infocity", "Kalinga Stadium Gate 1", 6);
			g.addEdge("Kalinga Stadium Gate 1", "BDA", 4);
			g.addEdge("BDA", "Fire Station Square", 8);
			g.addEdge("Fire Station Square", "CRPF Square", 3);
		}
		...
		public static void main(String[] args) throws IOException
		{
			...
			System.out.println("\n\t\t\t****WELCOME TO THE METRO COMPANION*****");
